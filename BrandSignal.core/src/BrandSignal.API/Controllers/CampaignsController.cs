...
[ApiController]
[Route("api/[controllers]")]// Sets the base web address path to: api/campaigns
public class CampaignsControllers : ControllerBase
{
    ...
    public CampaignsControllers(CreateCampaignCommandHandler commandHandler)
    {
